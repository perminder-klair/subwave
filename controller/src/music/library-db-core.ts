...
/** Returns the effective embedding dim after the last successful open(), or null if not open. */
export function getCurrentEmbeddingDim(): number | null { return currentEmbeddingDim; }
