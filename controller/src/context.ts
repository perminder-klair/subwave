...
import { zonedParts, zonedISODate, clockDisplay, spokenHourPhrase, spokenTimePhrase, spokenTimePhrases, spokenDaypartPhrase } from './time.js';
...
export function getClockContext(date = new Date()) {
  ...
  return {
    ...
    spokenTimeOptions: spokenTimePhrases(h, m),
