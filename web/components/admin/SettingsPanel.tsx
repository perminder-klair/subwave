...
import {
  ...
  Activity, Archive, Save, AlertTriangle, CalendarDays, Disc3, RefreshCw,
} from 'lucide-react';
...
function MusicSection({ data, form, setForm, busy, saveSettings, adminFetch, refresh }: MusicSectionProps) {
