  ...
  return (
    <section className="bs-navidrome bs-section">
      <div className="bs-navidrome-grid">
        <div className="bs-navidrome-copy">
          ...
          <p className="muted">
            ...
            comes from <strong style={{ color: 'var(--ink)' }}>your</strong>{' '}
      ...
      <p className="bs-navidrome-compat">
        <span className="bs-eyebrow" style={{ marginRight: 12 }}>ALSO WORKS WITH</span>
        {COMPATIBLE.map((c, i) => (
          <span key={c}>
            <span className="bs-navidrome-pill">{c}</span>
            {i < COMPATIBLE.length - 1 && <span aria-hidden="true" style={{ color: 'var(--muted)', margin: '0 6px' }}>·</span>}
          </span>
        ))}
      </p>
    </section>
