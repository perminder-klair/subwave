...
# ───────── DJ anti-repeat memory ─────────
# Every script prompt carries a recap of what the DJ recently said on air, with
# a "don't repeat this" instruction. Raise these when a solo show keeps
# recycling the same gags. Bigger recap = more prompt tokens on every call —
# raise llm.numCtx too on a small local model.
# DJ_RECAP_LIMIT=10     # aired lines in the recap (1-50)
# DJ_RECAP_MINUTES=120  # how far back (1-240; the session resets at 4h anyway)
# DJ_RECAP_CHARS=140    # chars kept per line (40-1000); longer persona
#                       # script lengths use 360/520 for skill segments
