...
- **Create `docs/QA-CHECKLIST.md`** — manual device matrix (≥1 physical iPhone, ≥1 physical Android):
  ...
  - CarPlay app (Stations list + Now Playing; entitlement-gated) and Android Auto app (dev/sideload builds only — stripped from Play production builds under the June 2026 TTS-content enforcement, see TESTING.md)
